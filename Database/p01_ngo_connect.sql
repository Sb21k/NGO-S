...
--
-- Host: localhost    Database: p01_ngo_connect
-- ------------------------------------------------------
...
INSERT INTO `items` VALUES (1,'Financial Aid'),(2,'Food & Nutrition'),(3,'Healthcare Support'),(4,'Disaster Relief'),(5,'Education Supplies'),(6,'Clothing & Shelter');
...
INSERT INTO `stories` VALUES (1,'500+ Children Educated','Providing school supplies and tuition for children in underserved communities to ensure they have a bright future.','Thanks to the generous donations, we have been able to partner with 5 local schools. We provided textbooks, uniforms, and paid tuition fees for over 500 children who were previously out of school.',5),(2,'1000+ Treatments Provided','Mobile clinics providing essential medical care to families who could not afford regular hospital visits.','Our mobile clinics traveled to 15 remote villages this year. We treated cases of malaria, malnutrition, and provided prenatal care to expectant mothers, saving countless lives.',3),(3,'10,000 Meals Served','Community kitchens providing daily nutritious meals to families in crisis and homeless individuals.','We established 3 new community kitchens. These kitchens run 7 days a week, providing hot, nutritious meals to homeless individuals and families affected by the recent economic downturn.',2),(4,'Emergency Shelter for Flood Victims','Providing temporary housing and safe haven for families displaced by recent natural disasters.','Following the recent floods, we set up temporary shelters accommodating 200 families. We provided bedding, clean water, and hygiene kits to ensure their safety and dignity.',4),(5,'Small Business Grants','Offering financial aid to single mothers to start their own small businesses and achieve financial independence.','We distributed financial grants to 50 women. 80% of them have successfully launched micro-businesses in tailoring and handicrafts, increasing their household income by 40%.',1);
...
INSERT INTO `users` VALUES (1,'SatyavratBind12','satya@123',3,'7454125486','satya@gmail.com','YSPQS2076G','Active','Durg, Chattisgarh',5,182,NULL),(2,'YashSinhe17','yashsinhe@123',1,'9475124568','yashsinhe@gmail.com','NZVPS1976F','Active','Yavatmal, Maharashtra',14,491,NULL),(3,'JanhaviBhor08','janhavi@123',2,'6451245789','janhavi@gmail.com','XCTYP2387T','Active','Mumbai, Maharashtra',14,472,NULL),(4,'NeelamBhapkar26','neelam@123',4,'8974541256','neelam@gmail.com','HABGS6518K','Active','Pune, Maharashtra',14,481,NULL),(5,'RajPatil18','raj@123',2,'8574856589','rajpatil@gmail.com','NZXRY3487G','Active','Nagothane,Maharashtra',14,473,106469787),(6,'AtifSayyed36','atif@123',3,'8745124512','atif@gmail.com','GVXFS1726T','Active','Jodhpur, Rajasthan',21,677,214892643),(7,'Omkar12','omkar@123',4,'4152465789','omkar@gmail.com','HBDGX1876H','Active','Pune, Maharashtra',16,552,454181748),(8,'KartikKc','Kartik@123',2,'4152478545','kartik@gmail.com','NASGE3628G','Active','Jodhpur, Rajasthan',21,677,721728153),(9,'Snehalmam','snehal@123',2,'478487485','snehal@gmail.com','CSXZF1324F','Active','Pune,Maharashtra',14,481,688611821);
...
-- Dump completed on 2026-01-27 15:16:06
